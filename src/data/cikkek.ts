...
(Szülőknek szóló tájékoztató)

A gyermek fejlődése az első életévekben rendkívül gyors és érzékeny folyamat. Ebben az időszakban a mozgás, a kommunikáció, az érzékelés, a gondolkodás és a szociális kapcsolatok alapjai formálódnak. Éppen ezért nagyon fontos, hogy a fejlődést már a legkorábbi életkorban figyelemmel kísérjük, és ha szükséges, időben segítséget biztosítsunk.

A szűrővizsgálatok célja, hogy minél korábban észrevegyük, ha egy gyermek fejlődése eltér a megszokott ütemtől. A korai felismerés lehetőséget ad arra, hogy a gyermek időben megkapja a számára szükséges támogatást.

A szűrés nem diagnózis, hanem egy első lépés: segít észrevenni azokat a jeleket, amelyek további vizsgálatot indokolhatnak. Ezek a vizsgálatok általában a gyermek mozgására, érzékelésére, kommunikációjára, viselkedésére és általános fejlődésére irányulnak.

A rendszeres szűréseknek az is fontos szerepük, hogy megnyugtassák a szülőket, ha a gyermek fejlődése megfelelő, illetve segítsenek időben szakemberhez irányítani a családot, ha támogatásra van szükség.
...
A csecsemők fejlődése az első életévben rendkívül gyors és összetett folyamat. A mozgás fejlődése szorosan összefügg az idegrendszer érésével, a szenzoros feldolgozással és a környezet felfedezésével.

Fontos tudni, hogy minden gyermek egyéni ütemben fejlődik. A fejlődési mérföldkövek segítenek abban, hogy nagyjából lássuk, milyen mozgások és képességek jelennek meg az egyes életkorokban.

0–3 hónapos kor

Ebben az időszakban a baba fokozatosan kezdi kontrollálni a fejét és a törzsét. A mozgások még nagyrészt reflexes jellegűek, de egyre tudatosabb aktivitás jelenik meg.

Jellemző mozgásfejlődési jelek

⋅ Hason fekve fejét oldalra fordítja  
⋅ Hason fekve a fejét 45°-ban emeli  
⋅ Később 90°-ban emeli a fejét, súlyát alkaron tartja  
⋅ Háton fekve a fejét középvonalban tartja  
⋅ Ülésbe húzva a fej csak kissé csuklik hátra  

Vizuális figyelem

⋅ Szemét a tárgy felé fordítja  
⋅ Vízszintes irányban követi a mozgó tárgyat  
⋅ Függőleges irányban is követi a mozgást  

Kézhasználat

⋅ Kezeivel markolászik  
⋅ Kezeit összeteszi  
⋅ A kezébe adott tárgyat rövid ideig megtartja  


3–6 hónapos kor

A baba ebben az időszakban sokkal aktívabbá válik. Megjelenik az átfordulás előkészítése és a tárgyak tudatos elérése.

Mozgásfejlődés

⋅ Háton fekve a kezét a térdéhez viszi  
⋅ Hátról oldalra fordul  
⋅ Ülésbe húzva fejét a törzs vonalában tartja  
⋅ Hason fekve testsúlyát kinyújtott karján tartja  
⋅ Hason fekve játék után nyúl  
⋅ Hátról hasra és hasról hátra fordul  

Szem-kéz koordináció

⋅ Kézben tartott tárgyat nézegeti  
⋅ Két kézzel nyúl a tárgyakért  
⋅ Egyik kezéből a másikba teszi a játékot  

Értelmi fejlődés

⋅ Felfedezi, hogy hatással van a környezetére  
⋅ Tárgyakat mozgat, hogy hangot keltsen  
⋅ Hangokkal és mozgással próbál kapcsolatot teremteni  

6–9 hónapos kor

Ebben az időszakban jelenik meg a helyváltoztató mozgás első formája. A baba aktívan mozog a környezetében és egyre stabilabb testkontrollt mutat.

Mozgásfejlődés

⋅ Hason fekvésben kúszó helyzetbe kerül  
⋅ Hason fekve körbe fordul  
⋅ Négykézláb helyzetbe kerül és hintázik  
⋅ Kúszik, karjával húzza magát  
⋅ Megjelenik a mászás  

Kézügyesség

⋅ Csörgőt aktívan ráz  
⋅ Célirányosan nyúl tárgyakért  
⋅ Apró tárgyakat felvesz  
⋅ Ugyanazt a tárgyat többféleképpen használja  

Értelmi fejlődés

⋅ A játékot egyik kezéből a másikba teszi  
⋅ Az elejtett tárgyat visszaveszi  
⋅ Kukucs játékban leveszi a kendőt  


9–12 hónapos kor

A baba egyre ügyesebben mozog a térben. A mászás és a felállás jelentős lépést jelent az önálló helyváltoztatás felé.

Mozgásfejlődés

⋅ Négykézláb helyzetből ülésbe vált  
⋅ Stabilan ül  
⋅ Bútorba kapaszkodva feláll  
⋅ Bútor mellett állva testsúlyát lábain tartja  
⋅ Oldalazva lépeget a bútorok mellett  
⋅ Állásból visszaereszkedik a padlóra  

Kézügyesség

⋅ Tárgyat elenged  
⋅ Tárgyakat edénybe tesz vagy kivesz  
⋅ Tárgyakat egymásra helyez  
⋅ Apró tárgyakat csippentő fogással felvesz  

Értelmi fejlődés

⋅ Megkeresi az elrejtett tárgyat  
⋅ Kérésre átadja a tárgyat  
⋅ Összeütögeti a játékokat  

12–15 hónapos kor

Ebben az időszakban jelenik meg az önálló járás első formája.

⋅ Bútorok között jár  
⋅ Kiskocsit tolva jár  
⋅ Segítség nélkül térdel  
⋅ Padlóról önállóan feláll  
⋅ Néhány lépést önállóan megtesz  

Kézügyesség

⋅ Kockákból tornyot épít  
⋅ Karikát pálcára húz  
⋅ Tárgyakat pakol dobozba  


15–18 hónapos kor

A járás egyre stabilabbá válik, és megjelennek az első összetettebb mozgások.

⋅ Egyedül jár, karjai lazán mozognak  
⋅ Lehajol és tárgyat vesz fel  
⋅ Kerekes játékot húz  
⋅ Gyorsabban jár  

Fontos megjegyzés

A fejlődési mérföldkövek iránymutatást adnak, de minden gyermek fejlődése egyéni. Ha a szülő bizonytalan a baba mozgásfejlődésével kapcsolatban, érdemes szakemberrel konzultálni és szükség esetén mozgásállapot-felmérést végezni.
